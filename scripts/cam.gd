...
func _on_minimapa_botones_cam_act() -> void:
	$Cam_1.modulate.a = 0.0
	$Cam_2.modulate.a = 0.0
	$Cam_3.modulate.a = 0.0
	$Cam_4.modulate.a = 0.0
	$Cam_5.modulate.a = 0.0
	$Cam_6.modulate.a = 0.0
	$Cam_7.modulate.a = 0.0
	$Cam_8.modulate.a = 0.0
	$Cam_9.modulate.a = 0.0
	$Cam_10A.modulate.a = 0.0
	$Cam_10B.modulate.a = 0.0
	$Cam_11A.modulate.a = 0.0
	$Cam_11B.modulate.a = 0.0
	if $"../..".camara_activa == 1:
		$Cam_1.modulate.a = 1.0
	if $"../..".camara_activa == 2:
		$Cam_2.modulate.a = 1.0
		
	if $"../..".camara_activa == 3:
		$Cam_3.modulate.a = 1.0
	...
	if $"../..".camara_activa == 4:
		$Cam_4.modulate.a = 1.0
	if $"../..".camara_activa == 5:
		$Cam_5.modulate.a = 1.0
	if $"../..".camara_activa == 6:
		$Cam_6.modulate.a = 1.0
	if $"../..".camara_activa == 7:
		$Cam_7.modulate.a = 1.0
	if $"../..".camara_activa == 8:
		$Cam_8.modulate.a = 1.0
	if $"../..".camara_activa == 9:
		$Cam_9.modulate.a = 1.0
	if $"../..".camara_activa == 10:
		$Cam_10A.modulate.a = 1.0
	if $"../..".camara_activa == 11:
		$Cam_10B.modulate.a = 1.0
	if $"../..".camara_activa == 12:
		$Cam_11A.modulate.a = 1.0
	if $"../..".camara_activa == 13:
		$Cam_11B.modulate.a = 1.0
